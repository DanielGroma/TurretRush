...
public class PlayerInstaller : MonoInstaller
{
    ...
    public override void InstallBindings()
    {
        ...
        Container.Bind<CarHealth>().AsSingle();
        Container.Bind<IDamageable>().To<CarHealth>().FromResolve();

        Container.BindInterfacesAndSelfTo<CarLoseHandler>().AsSingle();
        ...
        Container.Bind<TurretRotator>().FromComponentInHierarchy().AsSingle();
    }
}